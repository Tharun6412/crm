...
{
    /**
     * CPNG consumer registration form
     */
     ...
     * Store ther Data
    */
    public function store(CommercialValidationRequest $request)
    {
        // dd($request->all());
        // Data Preparation
        $add_consumer = Consumer::create([
            'segment_id' => SegmentType::COMMERCIAL->value,
            ...
            'firm_type_id' => $request->business_type_id,
            'fuel_id' => $request->fuel_type_id,
            'fuel_qty' => $request->fuel_qty,
            'peak_qty' => $request->peak_qty,
            'hours' => $request->hours,
            'req_pressure' => $request->req_pressure,
            'req_flow' => $request->req_flow,
