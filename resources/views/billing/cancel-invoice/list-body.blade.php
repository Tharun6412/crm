                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><x-auth.link class="dropdown-item link-modal" href="{{ url('bill/invoice/cancelInvoice/' . $invoice->id) }}" target="_blank"><i class="bi bi-chevron-right"></i>&nbsp;Cancel</x-auth.link></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
