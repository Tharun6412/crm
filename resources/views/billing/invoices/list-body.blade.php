                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        @if ($invoice->status_id == 2)
                                            <li><x-auth.link class="dropdown-item" href="{{ url('bill/creditNote/create/' . $invoice->id) }}" target="_blank"><i class="bi bi-chevron-right"></i>&nbsp;Add Credit/Debit Note</x-auth.link></li>
