        ...
        <div id="complaints-reports-list">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a href="#" class="nav-link active" id="nav-ga-tab" data-bs-toggle="tab" data-bs-target="#nav-ga" type="button" role="tab" aria-controls="nav-ga" aria-selected="true" data-url="{{ url('calls/reports/gaReport') }}">Ga Report</a>
                    <a href="#" class="nav-link" id="nav-category-tab" data-bs-toggle="tab" data-bs-target="#nav-category" type="button" role="tab" aria-controls="nav-category" aria-selected="false" data-url="{{ url('calls/reports/categoryReport') }}">Category Report</a>
                    <a href="#" class="nav-link" id="nav-deviation-tab" data-bs-toggle="tab" data-bs-target="#nav-deviation" type="button" role="tab" aria-controls="nav-deviation" aria-selected="false" data-url="{{ url('calls/reports/deviationReport') }}">Deviation Report</a>
                </div>
            </nav>
