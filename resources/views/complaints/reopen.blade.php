...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">Complaint ReOpen&nbsp;#{{ $complaint->code }}</h4>
        ...
        <div class="modal-body">
            ...
            {{-- Feedback --}}
            <hr/>
            <div id="reopen-success" class="mt-3">
                <h4>Reopen</h4>
                <form id="reopen-form" action="{{ url('calls/reopenUpdate/'.$complaint->id) }}" method="POST">
                    @csrf
                    <div class="row mb-2">
                    ...
                    <div class="mb-2" id="reopen-error"></div>
                    <div class="row">
...
@include('scripts.ajax-form-submit', ['form' => 'reopen'])
