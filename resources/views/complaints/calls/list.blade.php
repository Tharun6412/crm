                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" name="search" id="search" class="form-control no-focus-ring border-start-0 border-end-0" placeholder="Enter CRN, Meter Number,Mobile Number" value="{{ request()->search }}">
