...
@section('page-content')
    <div>
        <form action="{{ url('reports/consumer/refundReport') }}" id="refund-report-form">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto">
                    <a href="{{ url('reports/consumer/refundReport') }}" class="btn btn-warning"><i class="bi bi-arrow-clockwise"></i></a>
                </div>
            </div>
        </form>

        <div id="refund-report-loader" class="mt-3"></div>
    </div>
@endsection
{{-- Scripts --}}
@push('scripts')
