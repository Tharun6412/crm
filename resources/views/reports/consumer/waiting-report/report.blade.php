        ...
        <div class="tab-pane fade show active pt-2 bg-white" id="connection-progress" role="tabpanel" aria-labelledby="connection-progress-tab" tabindex="0">
            ...
            <div class="tab-content" id="nav-tabContentCns">
                ...
                <div class="tab-pane fade" id="nav-du-activity" role="tabpanel" aria-labelledby="nav-du-activity-tab" tabindex="0">
                    <form action="{{ url('reports/deliveryUnits/getDeliveryUnitProgress') }}" id="report-du-activity-search-form" method="GET">
                        <div class="d-flex justify-content-between align-items-center border my-2 bg-light p-2 bg-secondary-subtle rounded">
        ...
        <div class="tab-pane fade" id="emp-progress" role="tabpanel" aria-labelledby="emp-progress-tab" tabindex="0">
            <nav>
                <div class="nav nav-tabs bg-white" id="nav-tab3" role="tablist">
                    <button class="nav-link fs-5 border border-bottom-0 me-2 text-nowrap active" id="nav-du-progress-tab" data-bs-toggle="tab" data-bs-target="#nav-du-progress" type="button" role="tab" aria-controls="nav-du-progress" aria-selected="true"><i class="bi bi-people me-1"></i>&nbsp;Delivery Unit Wise Report</button>
                    <button class="nav-link fs-5 border border-bottom-0 me-2 text-nowrap" id="nav-team-progress-tab" data-bs-toggle="tab" data-bs-target="#nav-team-progress" type="button" role="tab" aria-controls="nav-team-progress" aria-selected="true"><i class="bi bi-people me-1"></i>&nbsp;Team Wise Report</button>
            ...
            <div class="tab-content" id="nav-tabContentEmp">
                {{-- Du wise Progress --}}
                <div class="tab-pane fade show active" id="nav-du-progress" role="tabpanel" aria-labelledby="nav-du-progress-tab"tabindex="0">
                    <form action="{{ url('reports/deliveryUnits') }}" id="report-du-progress-search-form" method="GET">
                        <div class="d-flex justify-content-between align-items-center border  border-primary bg-light my-2 p-2 rounded">
                            <h4 class="mb-0 ms-2">Delivery Unit Wise Report</h4>
                            <div class="row g-1">
                                ...
                                <div class="col-auto">
                                    <label for="du_date_from" class="form-label mb-1">From Date</label>
                                    <div class="input-group">
                                        <input type="text" name="du_date_from" id="du_date_from" class="form-control" placeholder="DD-MM-YYYY">
                                        <span class="input-group-text"><i class="bi bi-calendar3"></i></span>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <label for="du_date_to" class="form-label mb-1">To Date</label>
                                    <div class="input-group">
                                        <input type="text" name="du_date_to" id="du_date_to" class="form-control" placeholder="DD-MM-YYYY">
                                        <span class="input-group-text"><i class="bi bi-calendar3"></i></span>
                                    </div>
                                </div>
                                <div class="col-auto">
                    ...
                    <div id="report-du-progress-list"></div>
                </div>
...
@push('scripts')
    ...
    @include('scripts.ajax-form-search', ['form' => 'report-du-progress'])
    @include('scripts.ajax-form-search', ['form' => 'report-du-activity'])
    @include('scripts.datepicker', ['list' => ['date_from', 'date_to', 'status_date', 'conv_date_from', 'conv_date_to', 'team_date_from', 'team_date_to', 'du_date_from', 'du_date_to']])
@endpush