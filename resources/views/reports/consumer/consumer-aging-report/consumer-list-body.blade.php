...
<div class="d-flex justify-content-between">
    <div class="row gx-1 mb-1 pb-1">
        ...
        <div class="col-auto">
            <a href="{{ url('reports/consumer/consumerAgeingReport/consumersList') }}" class="btn btn-warning"><i class="bi bi-arrow-clockwise"></i></a>
        </div>
    ...
    <div>
        ...
        <a href="{{ url('reports/consumer/consumerAgeingReport/consumerExport') }}?{{ http_build_query(request()->all()) }}" class="btn btn-outline-info">
            <i class="bi bi-file-earmark-excel"></i>&nbsp;Export
        </a>
    </div>
</div>
<div class="bg-info-subtle border border-info p-1 mb-1 {{ (request()->has('connection_type_id') OR request()->has('charge_area') OR request()->has('area')) ? '' : 'd-none' }}" id="filterArea">
