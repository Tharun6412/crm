<form name="consumer-aging-reports-search-form" id="consumer-aging-reports-search-form"  action="{{ url('reports/consumer/consumerAgeingReport') }}" method="get">
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div class="d-flex flex-wrap align-items-center gap-2">
            ...
            <a href="{{ url('reports/consumer/consumerAgeingReport') }}" class="btn btn-warning btn-sm">
               <i class="bi bi-arrow-clockwise"></i>
            </a>
            <!-- Export -->
            <button type="button" id="exportBtn" class="btn btn-secondary btn-sm"><i class="bi bi-download"></i>&nbsp;Export</button>
        </div>
    </div>
</form>
<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="not_active-tab" data-bs-toggle="tab" data-bs-target="#not_active" type="button" role="tab" aria-controls="not_active" aria-selected="true">Not Activated</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="active-tab" data-bs-toggle="tab" data-bs-target="#active" type="button" role="tab" aria-controls="active" aria-selected="false">Activated</button>
    </li>
</ul>
