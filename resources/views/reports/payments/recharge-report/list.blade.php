...
@section('title', 'Consumer Recharge Report')

@section('page-title', 'Consumer Recharge Report')
...
@section('page-content')
    <div>
        <form name="consumer-recharge-report-search-form" id="consumer-recharge-report-search-form"  action="{{ url('reports/consumer/recharge') }}" method="get">
...
{{-- Scripts --}}
@push('scripts')
    @include('scripts.ajax-form-search', ['form' => 'consumer-recharge-report'])
