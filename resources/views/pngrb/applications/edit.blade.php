            ...
            <form id="add-domestic-form" action="{{ url('pngrb/applications/'.$application->id) }}" enctype="multipart/form-data">
                        ...
                        <div>
                            <select name="geo_area" id="geo_area" class="form-select" onchange="getDistrictsByGa(this.value)">
                                ...
                                @foreach ($geo_areas as $ga)
                                    <option @if ($application->gaId == $ga->code) selected="selected"
                                        
                                    @endif value="{{ $ga->id }}">{{ $ga->name }}</option>
                                @endforeach
                            </select>
                ...
                <div class="row mb-2">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="fname" id="fname" class="form-control" placeholder="First Name" value="{{ $application->name ?? "" }}"/>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="input-group">
                            ...
                            <input name="cof_name" id="cof_name" class="form-control" placeholder="Name" type="text" value="{{ $application->father_spouse ?? "" }}"/>
                        </div>
                    </div>
                </div>
                <div class="row mb-2 pt-2">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <input type="text" name="email" id="email" class="form-control" placeholder="Email" value="{{ $application->email ?? ""  }}"/>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="input-group">
                            ...
                            <input maxlength="10" type="text" name="phone" id="phone" class="form-control" placeholder="Mobile Number" aria-label="Mobile" aria-describedby="mobile" value="{{ $application->mobileNumber ?? "" }}"/>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">+91</span>
                            <input maxlength="10" type="text" name="phone_alt" id="phone_alt" class="form-control" placeholder="Alternate Contact Number" aria-label="Alt Mobile" aria-describedby="alt_mobile" value="{{ $application->whatsapp ?? "" }}"/>
                        </div>
                ...
                <div class="row mb-2">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <input name="hno" id="hno" class="form-control" placeholder="Example H.No:1-11" type="text" value="{{ $application->houseNo ?? "" }}, {{ $application->floor ?? "" }}"/>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <label class="form-label" for="street">Address line2&nbsp;:&nbsp;</label>
                        <input name="street" id="street" class="form-control" placeholder="Example Street-No: 2A" type="text" value="{{ $application->society ?? "" }}"/>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <label class="form-label" for="colony">Locality/Colony name&nbsp;:&nbsp;</label>
                        <input name="colony" id="colony" class="form-control" placeholder="Locality/Colony Name" type="text" value="{{ $application->area ?? "" }}"/>
                    </div>
                </div>
                <div class="row mb-2 pt-2">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <label class="form-label" for="city">Town/Village/City&nbsp;:&nbsp;</label>
                        <input name="city" id="city" class="form-control" placeholder="Town / Village / City" type="text" value="{{ $application->city ?? "" }}"/>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <input maxlength="6" name="pincode" id="pincode" class="form-control" placeholder="Pincode" type="text" value="{{ $application->pincode ?? "" }}"/>
