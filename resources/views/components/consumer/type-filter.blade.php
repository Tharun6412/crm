    ...
    <div class="dropdown-menu data-filter">
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
                <input type="checkbox" class="form-check-input" name="connection_type_id[1]" id="connection_type_id_1" value="1" @checked(in_array(1, $type_checked))>
                <label for="connection_type_id_1" class="form-check-label">PostPaid</label>
            </li>
            <li class="list-group-item">
                <input type="checkbox" class="form-check-input" name="connection_type_id[2]" id="connection_type_id_2" value="2" @checked(in_array(2, $type_checked))>
