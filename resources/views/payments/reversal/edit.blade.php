<div class="modal-dialog modal-xl">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <x-consumer.invoice-details :invoice="$payment->invoice" class="bg-primary-subtle" />
            {{-- Payment Details --}}
            ...
            <div id="reversal-success">
                <form id="reversal-form" action="{{ url('payments/reversalPaymentUpdate/'.$payment->id) }}">
                    ...
                    <div class="m-1" id="reversal-error"></div>
                    <div class="row">
                        <div class="offset-sm-3 col-sm-8">
                            <button type="submit" class="btn btn-danger">
                                <i class="bi bi-skip-backward" aria-hidden="true">&nbsp;</i>Reverse Payment
                            </button>
                        </div>
                    </div>
                </form>
