...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div id="loc-ca-create-success">
                <form action="{{ url('master/location/charge-areas') }}" method="POST" id="loc-ca-create-form">
                    @csrf
                    <div class="row mb-2">
                    ...
                    <div id="loc-ca-create-error" class="text-danger"></div>
                    <div class="row">
...
{{-- Scripts --}}
@include('scripts.ajax-form-submit', ['form' => 'loc-ca-create'])
<script type="module">
    $(function(){
