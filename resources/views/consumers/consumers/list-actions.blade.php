...
<div class="dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        @if ($consumer->status_id == ConsumerStatus::ACTIVATE->value)
            <li><x-auth.link class="dropdown-item link-modal" href="{{ url('consumers/payDeposit/'.$consumer->id.'/edit') }}"><i class="bi bi-chevron-right"></i>&nbsp;Pay Deposit</x-auth.link></li>
            <li><x-auth.link class="dropdown-item link-modal" href="{{ url('consumers/meterChange/'.$consumer->id.'/edit') }}"><i class="bi bi-chevron-right"></i>&nbsp;New Meter Change</x-auth.link></li>
