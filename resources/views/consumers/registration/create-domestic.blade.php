            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="mb-3">
                        ...
                        <span class="text-danger" id="title-error"></span><br/>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 d-none" id="scheme_data">
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            <h5 class="card-title">Security Deposit Details</h5>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">Name&nbsp;:&nbsp;<span id="scheme_name_details"></span></li>
                            <li class="list-group-item">Security Deposit&nbsp;:&nbsp;<span id="security"></span></li>
                            <li class="list-group-item">Registration&nbsp;:&nbsp;<span id="registration"></span></li>
                            <li class="list-group-item">Consumption&nbsp;:&nbsp;<span id="consumption"></span></li>
                            <li class="list-group-item">EMI Amount&nbsp;:&nbsp;<span id="emi_amount"></span></li>
                            <li class="list-group-item">Rental Amount&nbsp;:&nbsp;<span id="rental_amount"></span></li>
                            <li class="list-group-item">Minimum Payment&nbsp;:&nbsp;<span id="min_payment"></span></li>
                        </ul>    
                    </div>
                </div>
            </div>
