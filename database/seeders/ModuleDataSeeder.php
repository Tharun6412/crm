...
class ModuleDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('adm_modules')->insert([
            ...
            ['id' => 27, 'position' => 1, 'status' => 1, 'icon' => 'bi-file-text', 'package_id' => 1, 'parent_id' => 26, 'name' => 'Gas Bill', 'url' => 'bill/create'],
            ['id' => 28, 'position' => 2, 'status' => 1, 'icon' => 'bi-file-ruled', 'package_id' => 1, 'parent_id' => 26, 'name' => 'Invoice', 'url' => 'invoice/create'],
            ['id' => 29, 'position' => 3, 'status' => 1, 'icon' => 'bi-journal-plus', 'package_id' => 1, 'parent_id' => 26, 'name' => 'Credidnote', 'url' => 'credit/create'],
