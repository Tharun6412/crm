...
class ModuleDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('adm_modules')->insert([
            ...
            ['id' => 26, 'position' => 1, 'status' => 1, 'icon' => 'bi-file-plus', 'package_id' => 1, 'parent_id' => 3, 'name' => 'Create', 'url' => 'bill'],
            ['id' => 27, 'position' => 1, 'status' => 1, 'icon' => 'bi-file-text', 'package_id' => 1, 'parent_id' => 26, 'name' => 'Gas Bill', 'url' => 'bill/gasInvoice'],
            ['id' => 28, 'position' => 2, 'status' => 1, 'icon' => 'bi-file-ruled', 'package_id' => 1, 'parent_id' => 26, 'name' => 'Invoice', 'url' => 'bill/invoice'],
            ['id' => 29, 'position' => 3, 'status' => 1, 'icon' => 'bi-journal-plus', 'package_id' => 1, 'parent_id' => 26, 'name' => 'Credidnote', 'url' => 'bill/credit'],
            ['id' => 30, 'position' => 2, 'status' => 1, 'icon' => 'bi-cash-stack', 'package_id' => 1, 'parent_id' => 3, 'name' => 'Add Payment', 'url' => 'payment/create'],
            ['id' => 31, 'position' => 3, 'status' => 1, 'icon' => 'bi-credit-card-2-front', 'package_id' => 1, 'parent_id' => 3, 'name' => 'Online transactions', 'url' => 'payment/online-transactions'],
            ...
            ['id' => 39, 'position' => 2, 'status' => 1, 'icon' => 'bi-telephone-inbound', 'package_id' => 1, 'parent_id' => 37, 'name' => 'External Call', 'url' => 'calls/create-ext'],
            ...
            ['id' => 44, 'position' => 1, 'status' => 1, 'icon' => 'bi-compass', 'package_id' => 2, 'parent_id' => 7, 'name' => 'Locations', 'url' => ''],
                ...
                ['id' => 46, 'position' => 2, 'status' => 1, 'icon' => 'bi-pin-map', 'package_id' => 2, 'parent_id' => 44, 'name' => 'Clusters', 'url' => 'master/location/states'],
